...
/**
 * Configuration for converting XML documents to SQL.
 *
 * @author  Mike Pigott
 */
public final class SqlXmlConfig {
  private ArrayList<URL> schemaUrls;
  private ArrayList<File> schemaFiles;
  private String baseUri;
  private QName baseTagName;

  private SqlXmlConfig(QName rootTagName) {
   ...
   */
  public SqlXmlConfig(URL schema, QName rootTagName) {
    this(rootTagName);
   ...
   * @param rootTagName   The <code>QName</code> of the root element.
   */
  public SqlXmlConfig(File schema, String schemaBaseUri, QName rootTagName) {
    this(rootTagName);
